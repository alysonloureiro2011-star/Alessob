    ...
    *,
    ...
    return {
        ...
        "learning_state": {
            ...
            "real_collection_state": learning_loop.get("real_collection_state"),
            "real_analysis_state": learning_loop.get("real_analysis_state"),
            "insight_generation_state": learning_loop.get("insight_generation_state"),
            "controlled_validation_state": learning_loop.get("controlled_validation_state"),
            "controlled_adjustment_state": learning_loop.get("controlled_adjustment_state"),
            "accumulated_learning_state": learning_loop.get("accumulated_learning_state"),
            "episodic_memory_state": learning_loop.get("episodic_memory_state"),
            "performance_memory_state": learning_loop.get("performance_memory_state"),
        },
        "experiment_state": {
        ...
        "attention_state": {
            ...
            "skip_rate": attention_breakdown.get("skip_rate"),
            "avg_watch_time": attention_breakdown.get("avg_watch_time"),
            "completion_proxy": attention_breakdown.get("completion_proxy"),
            "share_rate": attention_breakdown.get("share_rate"),
            "save_rate": attention_breakdown.get("save_rate"),
            "comment_depth_score": attention_breakdown.get("comment_depth_score"),
            "views_over_time_points": attention_breakdown.get("views_over_time_points"),
            "views_over_time_points_count": attention_breakdown.get("views_over_time_points_count"),
            "views_momentum": attention_breakdown.get("views_momentum"),
            "views_velocity": attention_breakdown.get("views_velocity"),
            "series_continuation_rate": attention_breakdown.get("series_continuation_rate"),
            "resonance_score": attention_breakdown.get("resonance_score"),
            "reward_prediction_score": attention_breakdown.get("reward_prediction_score"),
        },
        "reflection_state": {
