...
def _signal_context(
    ...
    return {
        "source": "creative_planner_runtime_bridge",
        "mission_context": {
...
def build_creative_plan(
    ...
    signal_context = _signal_context(mission_decision, recent_memory)
    brand_context = _brand_context(overrides, mission_decision)
    ...
    try:
        ...
        mapped.notes.append("planner_bridge=creative_planner_runtime_bridge")
        ...
        legacy.notes.append("planner_bridge=creative_planner_runtime_bridge")
