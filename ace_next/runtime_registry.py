...
CURRENT_CAPABILITIES: tuple[CapabilitySpec, ...] = (
    ...
    CapabilitySpec("build_creative_plan", ".creative_planner", "build_creative_plan", required=True, stage="wave2"),
    ...
    CapabilitySpec("render_visual_foundation_card", ".visual_foundation_pack", "render_visual_foundation_card", required=False, stage="wave3"),
