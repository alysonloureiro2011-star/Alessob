...
class RuntimeStateV3:
    runtime_mode: str = "ACE_NEXT_CLEAN_V3"
    official_content_handler: str = "ace_next.runtime_v3.AceNextRuntimeV3.generate_or_bridge"
    official_publish_handler: str = "legacy_pipeline_then_ace_next_receipt_v3"
...
class AceNextRuntimeV3:
    ...
    def save_receipt_payload(self, payload: dict[str, Any]) -> dict[str, Any]:
    ...
    def generate_via_legacy_pipeline(self, trend: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            self.save_receipt_payload(payload)
            if not payload["ok"]:
